						...
						<li class="span4">
							<div class="thumbnail">
								<a href="product_details.html" class="overlay"></a> <a
									...
									title="add to cart"><span class="icon-search"></span> Xem thêm </a> <a href="<c:url value='/chi-tiet-san-pham/${item.product_id }' />"><img
									src="<c:url value='/assets/user/img/${item.img }' />" alt=""></a>
								<div class="caption cntr">
									<p>${ item.name }</p>
									<p>
										<strong><fmt:formatNumber type="number" groupingUsed="true" value="${item.price}" /> VNĐ</strong>
									</p>
									<h4>
